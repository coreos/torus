agro1: ./agro --etcd 127.0.0.1:2379 --debug --debug-init --port 4321 --datadir local-cluster/agro1  --peer-address http://127.0.0.1:40000 --size 5GiB --auto-join
agro2: ./agro --etcd 127.0.0.1:2379 --debug --debug-init --port 4322 --datadir local-cluster/agro2 --peer-address adp://127.0.0.1:40001 --size 5GiB --writelevel one --auto-join
