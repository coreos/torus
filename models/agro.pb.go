...
func (this *BlockLayer) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&models.BlockLayer{")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	s = append(s, "Content: "+fmt.Sprintf("%#v", this.Content)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Directory) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&models.Directory{")
	if this.Metadata != nil {
		s = append(s, "Metadata: "+fmt.Sprintf("%#v", this.Metadata)+",\n")
	}
	keysForFiles := make([]string, 0, len(this.Files))
	for k, _ := range this.Files {
		keysForFiles = append(keysForFiles, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForFiles)
	mapStringForFiles := "map[string]*FileEntry{"
	for _, k := range keysForFiles {
		mapStringForFiles += fmt.Sprintf("%#v: %#v,", k, this.Files[k])
	}
	mapStringForFiles += "}"
	if this.Files != nil {
		s = append(s, "Files: "+mapStringForFiles+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *FileEntry) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&models.FileEntry{")
	s = append(s, "Chain: "+fmt.Sprintf("%#v", this.Chain)+",\n")
	s = append(s, "Sympath: "+fmt.Sprintf("%#v", this.Sympath)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *FileChainSet) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&models.FileChainSet{")
	keysForChains := make([]uint64, 0, len(this.Chains))
	for k, _ := range this.Chains {
		keysForChains = append(keysForChains, k)
	}
	github_com_gogo_protobuf_sortkeys.Uint64s(keysForChains)
	mapStringForChains := "map[uint64]uint64{"
	for _, k := range keysForChains {
		mapStringForChains += fmt.Sprintf("%#v: %#v,", k, this.Chains[k])
	}
	mapStringForChains += "}"
	if this.Chains != nil {
		s = append(s, "Chains: "+mapStringForChains+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *PeerInfo) GoString() string {
	...
	s := make([]string, 0, 12)
	s = append(s, "&models.PeerInfo{")
	s = append(s, "UUID: "+fmt.Sprintf("%#v", this.UUID)+",\n")
	s = append(s, "Address: "+fmt.Sprintf("%#v", this.Address)+",\n")
	s = append(s, "LastSeen: "+fmt.Sprintf("%#v", this.LastSeen)+",\n")
	s = append(s, "TotalBlocks: "+fmt.Sprintf("%#v", this.TotalBlocks)+",\n")
	s = append(s, "UsedBlocks: "+fmt.Sprintf("%#v", this.UsedBlocks)+",\n")
	s = append(s, "LastRebalanceFinish: "+fmt.Sprintf("%#v", this.LastRebalanceFinish)+",\n")
	s = append(s, "LastRebalanceBlocks: "+fmt.Sprintf("%#v", this.LastRebalanceBlocks)+",\n")
	s = append(s, "Rebalancing: "+fmt.Sprintf("%#v", this.Rebalancing)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Ring) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&models.Ring{")
	s = append(s, "Type: "+fmt.Sprintf("%#v", this.Type)+",\n")
	...
	github_com_gogo_protobuf_sortkeys.Strings(keysForAttrs)
	mapStringForAttrs := "map[string][]byte{"
	for _, k := range keysForAttrs {
		mapStringForAttrs += fmt.Sprintf("%#v: %#v,", k, this.Attrs[k])
	}
	mapStringForAttrs += "}"
...
func (this *INodeRef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&models.INodeRef{")
	s = append(s, "Volume: "+fmt.Sprintf("%#v", this.Volume)+",\n")
	s = append(s, "INode: "+fmt.Sprintf("%#v", this.INode)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringAgro(v interface{}, typ string) string {
...
func extensionToGoStringAgro(e map[int32]github_com_gogo_protobuf_proto.Extension) string {
	if e == nil {
		return "nil"
	}
